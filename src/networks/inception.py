...
def inception_module(e, out_filters, keep_prob, reg=None, scope='inception_module'):
...
def deception_module(e, dim_filters, out_filters, scope='deception_module', reg=None, final_act = tf.nn.relu):
  with tf.variable_scope(scope):
    conv_1x1_1 = conv_1x1(
      inputs      = e,
      num_filters = out_filters,
